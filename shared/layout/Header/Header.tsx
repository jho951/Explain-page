...
import { HeaderProps } from '@/shared/layout/Header/Header.types.ts';
import { Logo } from '@/shared/ui/Logo';
import { HeaderAuthActions } from '@/shared/layout/Header/HeaderAuthActions';
import { HeaderDesktopNav } from '@/shared/layout/Header/HeaderDesktopNav';
import { HeaderMobileMenu } from '@/shared/layout/Header/HeaderMobileMenu';
import { ICON_BASE_PATH } from '@/constants/icon.ts';
import { useIsMobile } from '@/hooks/useDevice';
import { buildStartFrontendSignInUrl } from '@/libs/auth-routing';
import { isGatewayLogoutConfigured, logoutAuthSession } from '@/api/auth';
