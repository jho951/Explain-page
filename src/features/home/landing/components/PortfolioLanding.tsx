...
const LANDING_COPY = {
  ko: {
    eyebrow: 'EDITOR SERVER',
    brand: 'Explain Editor',
    ...
    services: [
      { name: 'Editor-server', role: 'UI' },
      { name: 'gateway-server', role: 'Edge' },
      { name: 'auth-server', role: 'SSO' },
      { name: 'user-server', role: 'User' },
      { name: 'authz-server', role: 'Admin check' },
      { name: 'redis-server', role: 'Session' },
      { name: 'monitor-server', role: 'Metrics' },
    ],
